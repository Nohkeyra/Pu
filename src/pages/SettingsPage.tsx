                ...
                <div className="flex items-center gap-2">
                  {soundEffectsEnabled && (
                    <button
                      ...
                      className="px-2.5 py-1 rounded-lg bg-violet-500/10 hover:bg-violet-500/20 border border-violet-500/20 text-violet-700 dark:text-violet-300 font-bold text-[11px] transition-colors flex items-center gap-1 focus-visible:ring-2 focus-visible:ring-violet-500"
