...
const ToastContainer: React.FC<ToastContainerProps> = ({ toasts, dismiss }) => {
  return (
    <div className="fixed bottom-[calc(88px+env(safe-area-inset-bottom,12px))] right-5 z-[9999] flex flex-col gap-3 w-full max-w-sm px-4 sm:px-0 pointer-events-none">
      <AnimatePresence>
        {toasts.map((t) => (
