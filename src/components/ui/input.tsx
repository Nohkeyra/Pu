...
function Input({ className, type, ...props }: React.ComponentProps<"input">) {
  return (
    <input
      ...
      data-slot="input"
      className={cn(
        "file:text-deep-forest placeholder:text-stone/55 selection:bg-[var(--color-sunshine-cta)]/30 selection:text-deep-forest",
        ...
        "outline-none",
        "focus-visible:border-[var(--color-sunshine-cta)]/40 focus-visible:bg-white focus-visible:shadow-[0_0_0_4px_rgba(253,94,2,0.12)] dark:focus-visible:bg-white/10",
