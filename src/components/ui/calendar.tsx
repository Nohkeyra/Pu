...
function Calendar({
  ...
  return (
    <DayPicker
      ...
      className={cn(
        "bg-forest-green group/calendar p-3 rounded-xl border border-deep-forest/10 [[data-slot=card-content]_&]:bg-transparent [[data-slot=popover-content]_&]:bg-transparent",
      ...
      classNames={{
        ...
        button_previous: cn(
          ...
          "size-8 aria-disabled:opacity-50 p-0 select-none text-deep-forest/60 hover:text-deep-forest hover:bg-deep-forest/5",
