...
export function Step2DishSelection({
  ...
  const resolveDishImage = (item: any): string => {
    ...
    if (id.includes('nasi') || name.includes('nasi')) {
      // Fallback for any other nasi (goreng, campur, etc)
      return '/assets/images/nasi_lemak_drawn_1786678078469.jpg'; // Better than nasi-campur real photo to keep it illustrated
    }
    ...
    // Ultimate fallback for any unclassified food
    return '/assets/images/nasi_lemak_drawn_1786678078469.jpg';
  };
  ...
  const renderMenuItemCard = (item: any) => {
    ...
    return (
      ...
      >
        ...
        {dishImg && (
          <div className="w-12 h-12 sm:w-14 sm:h-14 rounded-lg overflow-hidden bg-stone-100 dark:bg-stone-800 shrink-0 border border-amber-500/20 dark:border-white/10 shadow-sm relative">
            <img
