    ...
    <AnimatePresence>
      {isVisible && (
        <motion.button
          ...
          onClick={scrollToTop}
          className={`fixed right-4 md:right-6 z-[110] min-h-[44px] min-w-[44px] p-3 md:p-3.5 bg-gradient-to-tr from-sunshine to-crisp-carrot text-white rounded-full shadow-lg hover:shadow-xl hover:scale-105 active:scale-95 transition-all duration-300 flex items-center justify-center ${
            isOrderPage
