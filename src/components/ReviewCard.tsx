  ...
  return (
    <div className="group relative bg-cream-dark/60 dark:bg-card/60 backdrop-blur-md rounded-2xl p-8 min-h-[320px] flex flex-col transition-all duration-500 hover:-translate-y-2 hover:shadow-[0_20px_50px_rgba(232,144,37,0.12)] border border-stone/15 dark:border-white/10 hover:border-[var(--color-sunshine-cta)]/40 hover:bg-[var(--color-sunshine-cta)]/5">
      ...
      <div className="mt-8 flex items-center gap-4">
        <div className="w-12 h-12 rounded-full bg-deep-forest/[0.04] dark:bg-white/5 border border-deep-forest/10 dark:border-white/10 flex items-center justify-center">
          <span className="font-display font-semibold text-lg text-[var(--color-sunshine-cta)]">
            {name.charAt(0)}
          </span>
        </div>
        <div>
