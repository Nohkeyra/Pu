  ...
  return (
    <Card className="bg-card dark:bg-card/40 border border-stone-200/80 dark:border-white/10 p-5 sm:p-6 shadow-sm space-y-5">
      ...
      <CardContent className="space-y-5 p-0 pt-0">
        ...
        {isAddingLocation && (
          <Card variant="outlined" className="bg-stone-50 dark:bg-stone-900/40 p-4 rounded-xl border border-stone-200 dark:border-stone-800 space-y-4 shadow-none">
              ...
              >
                <div className="space-y-1.5">
                  <div className="flex items-center justify-between gap-2">
                    ...
                    {loc.isDefault && (
                      <span className="inline-flex items-center gap-1 px-2 py-0.5 rounded text-xs font-bold bg-stone-100 dark:bg-stone-800 text-stone-600 dark:text-stone-400 border border-stone-200/50 dark:border-stone-700">
                ...
                <div className="flex items-center justify-between pt-2 border-t border-stone-100 dark:border-white/5 text-xs">
                  {!loc.isDefault ? (
                    <Button
                      ...
                      className="h-auto p-0 text-stone-500 hover:text-deep-forest dark:hover:text-stone-200 font-bold text-xs"
                    >
                      {t('Set as Default', 'Jadikan Utama')}
                    </Button>
                  ) : (
                    <span className="text-stone-400 dark:text-stone-500 text-xs font-semibold">{t('Primary Address', 'Alamat Utama')}</span>
                  )}
                  ...
                  <div className="flex items-center gap-1">
                    <Button
                      ...
                      className="h-7 w-7 text-stone-400 hover:text-deep-forest dark:hover:text-white rounded transition-colors"
                    ...
                    <Button
                      ...
                      className="h-7 w-7 text-rose-400 hover:text-rose-600 rounded transition-colors"
