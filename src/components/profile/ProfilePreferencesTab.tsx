...
export function ProfilePreferencesTab({
  ...
  return (
    <div className="bg-card dark:bg-card/40 border border-stone/15 dark:border-white/10 rounded-2xl p-5 sm:p-6 shadow-sm space-y-6">
      <div className="pb-4 border-b border-stone/15 dark:border-white/10">
      ...
      <div className="space-y-4">
        ...
        <div className="flex items-center justify-between p-4 rounded-2xl bg-muted/30 border border-stone/15 dark:border-white/10">
