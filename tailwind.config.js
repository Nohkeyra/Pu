  ...
  theme: {
    extend: {
      ...
      fontFamily: {
        ...
        artistic: ['"Uncial Antiqua"', 'serif'],
        hype:    ['"Outfit"', '"Plus Jakarta Sans"', 'sans-serif'],
        bebas:   ['"Outfit"', 'sans-serif'],
        accent:  ['ui-monospace', 'SFMono-Regular', 'Menlo', 'Monaco', 'Consolas', 'monospace'],
        urban:   ['"Plus Jakarta Sans"', 'system-ui', 'sans-serif'],
      },
      borderRadius: {
        sm: 'var(--radius-sm)',
        md: 'var(--radius-md)',
