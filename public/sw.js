...
if (isDevSandbox) {
  console.log('[Service Worker] Running in development sandbox. Unregistering without reload...');
  ...
  self.addEventListener('activate', (event) => {
    event.waitUntil(
      self.registration.unregister().then(() => {
        console.log('[Service Worker] Successfully unregistered in dev sandbox.');
      })
    );
  });
} else {
